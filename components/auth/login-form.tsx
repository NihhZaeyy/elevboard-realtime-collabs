...
import { loginCredential } from "@/services/auth";
import { credentialLoginSchema } from "./auth-schema";
...
export function LoginForm({
  ...
  const form = useForm<z.infer<typeof credentialLoginSchema>>({
  ...
  const handleAppleLogin = () => {
    // Redirect to Apple OAuth or open popup
    // window.location.href = `${process.env.NEXT_PUBLIC_API_AUTH_URL}/oauth/apple`;
  };
